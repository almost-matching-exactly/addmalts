...
def doubly_robust_parallel(dataset_iteration, dataset_directory):
    ...
    treated_file_name = open(dataset_directory + '/dataset_' + str(seed) + '/doubly_robust_rfps.pkl', 'wb')
    ...
    CATE_doubly_robust_df.to_csv(dataset_directory + '/dataset_' + str(seed) + '/dr_rfps_CATE.csv')
